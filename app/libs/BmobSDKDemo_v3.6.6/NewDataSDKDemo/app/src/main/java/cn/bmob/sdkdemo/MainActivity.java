...
public class MainActivity extends BaseActivity {
    ...
    private void getServerTime() {
        addSubscription(Bmob.getServerTime(new QueryListener<Long>() {
...
//			  response.send(json.Type);
//			}
        //测试json请求参数
        AsyncCustomEndpoints ace = new AsyncCustomEndpoints();
        JSONObject obj = new JSONObject();
        addSubscription(ace.callEndpoint("findObj", obj, new CloudCodeListener() {
            ...
            public void done(Object object, BmobException e) {
                if (e == null) {
                    ...
                    log("访问云端usertest方法失败:" + e.getMessage());
                }
            }
        }));
//		//不带请求的云端代码
...
//		});
    ...
    private void realTime() {
        ...
        rtd.start(new ValueEventListener() {
            ...
            public void onConnectCompleted(Exception ex) {
                ...
                if (rtd.isConnected()) {
                    // 监听表更新 可以监听行的更新 指定objectId
                    rtd.subTableUpdate("Error");
                    // rtd.subRowUpdate("Person", "NzxqDDDZ");
                }
            }
        });
    }
    ...
    private void getAllTableSchema() {
        addSubscription(Bmob.getAllTableSchema(new QueryListListener<BmobTableSchema>() {
    ...
    public void getTableSchema() {
        addSubscription(Bmob.getTableSchema("_User", new QueryListener<BmobTableSchema>() {
