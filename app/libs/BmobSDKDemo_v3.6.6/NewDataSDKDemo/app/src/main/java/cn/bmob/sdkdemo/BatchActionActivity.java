...
public class BatchActionActivity extends BaseActivity {
	...
	private void batchInsert(){
		...
		addSubscription(new BmobBatch().insertBatch(persons).doBatch(new QueryListListener<BatchResult>() {
	...
	private void batchUpdate(){
		...
		p1.setObjectId("68a55d61d3");
		p1.setAge(24);
		Person p2 = new Person();
		p2.setObjectId("49a042c176");
		p2.setAge(45);
		p2.setGender(false);
		Person p3 = new Person();
		p3.setObjectId("56aa4a62ad");
		p3.setAge(56);
		...
		addSubscription(new BmobBatch().updateBatch(persons).doBatch(new QueryListListener<BatchResult>() {
	...
	private void batchDelete(){
		List<BmobObject> persons = new ArrayList<BmobObject>();
		Person p1 = new Person();
		p1.setObjectId("NzxqDDDZ");
		Person p2 = new Person();
		p2.setObjectId("6F14JJJa");
		Person p3 = new Person();
		p3.setObjectId("KEQVoooH");
		...
		batch.deleteBatch(persons);
		addSubscription(new BmobBatch().deleteBatch(persons).doBatch(new QueryListListener<BatchResult>() {
	...
	public void batch(){
		...
		//执行批量操作
		addSubscription(batch.doBatch(new QueryListListener<BatchResult>(){
