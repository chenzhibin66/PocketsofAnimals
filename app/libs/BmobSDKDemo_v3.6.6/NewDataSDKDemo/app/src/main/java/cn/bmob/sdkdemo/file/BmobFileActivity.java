...
public class BmobFileActivity extends BaseActivity implements OnClickListener, FileChooserListener{
	...
	private void uploadMovoieFile(File file) {
		...
		/*addSubscription(bmobFile.uploadObservable(new ProgressCallback() {//上传文件操作
			@Override
	...
	String filePath_mp3 = "/storage/emulated/0/a.jpg";
	String filePath_mp31 = "/storage/emulated/0/a.jpg";
	String filePath_lrc = "/storage/emulated/0/a1.jpg";
	String filePath_lrc1 = "/storage/emulated/0/a1.jpg";
	...
	public void insertBatchDatasWithOne(){
		...
		filePaths[2] = filePath_mp31;
		filePaths[3] = filePath_lrc1;
		//批量上传是会依次上传文件夹里面的文件
	...
	public void insertBatch(List<BmobObject> files){
		addSubscription(new BmobBatch().insertBatch(files).doBatch(new QueryListListener<BatchResult>() {
			@Override
