...
public class MapAcitvity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(MapAcitvity.this,
        ...
        if (!permissionList.isEmpty()){
            ...
            ActivityCompat.requestPermissions(MapAcitvity.this,permission,1);
        } else {
            requestLocation();
        }
    }
